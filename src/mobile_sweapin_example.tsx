...
//           },
//         });
//         setImageStyle({ transform: `translateY(${deltaY}px)`, transition: "none" });
//       }
//     } else {
//       if (deltaX > 50) swipeType = "like";
//       if (deltaX < -50) swipeType = "delete";
...
//       // 1. Slide out to top
//       setImageStyle({ transform: `translateY(${-window.innerHeight}px)`, transition: "transform 0.3s ease-out" });
...
//         setImageStyle({ transform: `translateY(${window.innerHeight}px)`, transition: "none" });

//         // 4. Slide in from bottom
//         requestAnimationFrame(() => {
//           requestAnimationFrame(() => {
//             setImageStyle({ transform: "translateY(0)", transition: "transform 0.3s ease-out" });
//           });
//         });
//       }, 300);
...
//       setImageStyle({ transform: "translateY(0)", transition: "transform 0.3s cubic-bezier(0.175, 0.885, 0.32, 1.275)" });
...
//                               width: "100%",
//                               height: "100%",
//                               transform: index === 0 ? imageStyle.transform : "none",
//                               transition: index === 0 ? imageStyle.transition : "none",
//                             }}
//                           >
//                             <ProfileImage
//                               src={currentSrc}
